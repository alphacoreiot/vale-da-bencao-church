...
# Adicionar link de Doação antes de Contato no header
old_header = '''<a href="{{ route('section.show', 'galeria') }}" class="nav-link" data-route="galeria">Galeria</a>
        <a href="{{ route('section.show', 'contato') }}" class="nav-link" data-route="contato">Contato</a>'''

new_header = '''<a href="{{ route('section.show', 'galeria') }}" class="nav-link" data-route="galeria">Galeria</a>
