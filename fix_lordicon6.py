#!/usr/bin/env python3
# Script para trocar Lordicon para amor/doacao - coracao com maos
...
# Lordicon de amor/doacao - mãos segurando coração (giving heart)
...
print("Lordicon trocado para amor/doacao!")
