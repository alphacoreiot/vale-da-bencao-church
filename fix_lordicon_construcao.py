#!/usr/bin/env python3
# Script para trocar Lordicon da página de doações para construção
...
# Novo Lordicon - Construção/Building (casa sendo construída)
new_icon = '''<div style="margin-bottom: 15px;">
                <lord-icon
                    src="https://cdn.lordicon.com/poqfpjby.json"
                    trigger="loop"
                    delay="2000"
                    colors="primary:#D4AF37,secondary:#ffffff"
                    style="width:80px;height:80px">
...
print("Lordicon trocado para construção!")
